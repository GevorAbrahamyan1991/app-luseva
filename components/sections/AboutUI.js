      ...
      <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-between gap-4">
          <Description>
            ...
            ստեղծագործ թիմը թույլ են տալիս ապահովել տոնական տորթերի անհավանական
            տեսականի՝ օգտագործելով միայն թարմ և բարձրակարգ բաղադրիչներ։ Մենք
            առաջարկում ենք գեղագիտական և համային բացառիկ լուծումներ Ձեր կյանքի
            կարևորագույն իրադարձությունների համար՝ սկսած նրբագեղ հարսանեկան
            ձևավորումներից մինչև վառ մանկական երևակայություններ։ LusEva Cakes-ը
            երաշխավորում է որակ, ճշգրտություն և անմոռանալի քաղցրություն՝
            բավարարելով մեր հաճախորդների ամենաբարձր և նրբաճաշակ պահանջները։
          </Description>
          <div>
